...
public class AnimatedImageSpan extends DynamicDrawableSpan {
     ...
     */
    @Override
    public int getSize(Paint paint, CharSequence text, int start, int end, Paint.FontMetricsInt fm) throws NullPointerException{
      
    	Drawable d = getDrawable(); //need to be fixed. check if the d is null? by bangelua
