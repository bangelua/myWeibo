...
public class BlockWords extends Activity {
    ...
    public void onCreate(Bundle bb) {
            ...
            public void onItemClick(AdapterView<?> arg0, View arg1, final int arg2,
                ...
                dialog.setPositiveButton("删除", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        BlockWordsListAdatper adapter = new BlockWordsListAdatper(BlockWords
                                .this, MumuWeiboUtility.BlockWordsList);
        ...
        BlockWordsListAdatper adapter = new BlockWordsListAdatper(BlockWords.this,
				MumuWeiboUtility.BlockWordsList);
