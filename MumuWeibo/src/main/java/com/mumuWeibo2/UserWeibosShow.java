...
public class UserWeibosShow extends Activity {
    ...
    private void getUserWeibos() {
        ...
        api.userTimeline(uid, since, 0, num, 1, false, FEATURE.ALL, false, new
                GetUserWeibosListener());
            ...
            handler.post(new Runnable() {
                ...
                public void run() {
                    try {
                        ...
                        if (weiboCount > 0)
                            Toast.makeText(UserWeibosShow.this, "收到" + weiboCount + "条新微博", Toast
                                    .LENGTH_SHORT).show();
                        WeiboListAdapter adapter = new WeiboListAdapter(UserWeibosShow.this, list);
                        lv.setAdapter(adapter);
                        lv.onRefreshComplete();
                        if (isMe) {
                            ...
                            MumuWeiboUtility.saveWeiboList(UserWeibosShow.this, MumuWeiboUtility
                                    .LIST_FLAG.MYWEIBOS);
                        }
            ...
            handler.post(new Runnable() {
                ...
                public void run() {
                    try {
                        ...
                        if (weiboCount == 0) {
                            Toast.makeText(UserWeibosShow.this, "没有更多微博了！", Toast.LENGTH_SHORT)
                                    .show();
                            //loadMore.setVisibility(ViewGroup.GONE);
                            lv.onLoadMoreComplete(true);
                            return;
                        }
                        Toast.makeText(UserWeibosShow.this, "收到" + weiboCount + "条微博", Toast
                                .LENGTH_SHORT).show();
            ...
            handler.post(new Runnable() {
                ...
                public void run() {
                    try {
                        ...
                        Toast.makeText(UserWeibosShow.this, "收到" + weiboCount + "微博", Toast
                                .LENGTH_SHORT).show();
                        WeiboListAdapter adapter = new WeiboListAdapter(UserWeibosShow.this, list);
                        lv.setAdapter(adapter);
                    } catch (JSONException e) {
            ...
            handler.post(new Runnable() {
                ...
                public void run() {
                    try {
                        ...
                        Toast.makeText(UserWeibosShow.this, "收到" + weiboCount + "条收藏", Toast
                                .LENGTH_SHORT).show();
    ...
    private void getAtMe() {
        ...
        api.mentions(since, 0, num, 1, AUTHOR_FILTER.ALL, SRC_FILTER.ALL, TYPE_FILTER.ALL, false,
                new GetAtListener());
            ...
            handler.post(new Runnable() {
                ...
                public void run() {
                    try {
                        ...
                        if (weiboCount != 0)
                            Toast.makeText(UserWeibosShow.this, "收到" + weiboCount + "条@微博", Toast
                                    .LENGTH_SHORT).show();
                        WeiboListAdapter adapter = new WeiboListAdapter(UserWeibosShow.this,
                                MumuWeiboUtility.AtMsgList);
                        lv.setAdapter(adapter);
                        lv.onRefreshComplete();
                        MumuWeiboUtility.saveWeiboList(UserWeibosShow.this, MumuWeiboUtility
                                .LIST_FLAG.ATMSG);
    ...
    private void getMoreAtMe() {
        ...
        api.mentions(0, maxId, 20, 1, AUTHOR_FILTER.ALL, SRC_FILTER.ALL, TYPE_FILTER.ALL, false,
                new GetMoreAtListener());
        ...
        public void onComplete(final String arg0) {
            ...
            handler.post(new Runnable() {
                ...
                public void run() {
                    ...
                    if (weiboCount != 0)
                        Toast.makeText(UserWeibosShow.this, "收到" + weiboCount + "新的评论", Toast
                                .LENGTH_SHORT).show();
                    WeiboListAdapter adapter = new WeiboListAdapter(UserWeibosShow.this,
                            MumuWeiboUtility.CommentsList);
                    lv.setAdapter(adapter);
                    lv.onRefreshComplete();
                    MumuWeiboUtility.saveWeiboList(UserWeibosShow.this, MumuWeiboUtility
                            .LIST_FLAG.COMMENTS);
    ...
    private void getMoreComment() {
        ...
        CommentsAPI api3 = new CommentsAPI(AccessTokenKeeper.readAccessToken(UserWeibosShow.this));
        api3.toME(0, Long.parseLong(maxId) - 1, 20, 1, AUTHOR_FILTER.ALL, SRC_FILTER.ALL, new
                GetMoreCommentsListener());
        ...
        public void onComplete(final String arg0) {
            ...
            handler.post(new Runnable() {
                ...
                public void run() {
                    ...
                    Toast.makeText(UserWeibosShow.this, "收到" + weiboCount + "条评论", Toast
                            .LENGTH_SHORT).show();
                ...
                listDia.setItems(mList, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        switch (which) {
                            ...
                            default:
                                // 	Toast.makeText(CommentListShow.this, "操作尚未设置", Toast
                                // .LENGTH_SHORT).show();
                        }
                    }
                });
