...
public class WeiboListParser {
    ...
    public static int parse(JSONObject jo, ArrayList<WeiboInfo> list, int location) throws
            JSONException {
        ...
        for (int i = 0; i < weibo_count; i++) {
            ...
            if (weiboInfo.getWeiboUser() == null ||
                    !MumuWeiboUtility.LoginUser.getName()
                            .equals(weiboInfo.getWeiboUser().getName()) && !weiboInfo
                            .getWeiboUser()
                            .isFollowing)
                continue;
    ...
    public static int parseFavor(String jo, ArrayList<WeiboInfo> list, int location) throws
            JSONException {
